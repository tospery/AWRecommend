...
@interface SVWebViewController () <UIWebViewDelegate/*, UIAlertViewDelegate, NJKWebViewProgressDelegate*/>
...
- (instancetype)initWithLink:(NSString *)link title:(NSString *)title {
    if (self = [self initWithURL:JXURLWithStr(link) title:title]) {
