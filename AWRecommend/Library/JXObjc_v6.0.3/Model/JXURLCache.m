...
- (NSString *)cacheRequestFileName:(NSString *)requestUrl {
    return [requestUrl exMD5Bit32String]; // [Util md5Hash:requestUrl];
}

- (NSString *)cacheRequestOtherInfoFileName:(NSString *)requestUrl {
    return [[NSString stringWithFormat:@"%@-otherInfo", requestUrl] exMD5Bit32String];
}
...
//    if (![JXURLCache networkAvailable]/*![AFNetworkReachabilityManager sharedManager].isReachable*/) {
//        return nil;
//    }
