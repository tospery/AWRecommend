...
@implementation JXCoreDataImporter
#define debug 0
...
- (void)establishToOneRelationship:(NSString*)relationshipName
    ...
    [JXCoreDataImporter saveContext:relatedObject.managedObjectContext];
    [JXCoreDataImporter saveContext:object.managedObjectContext];
